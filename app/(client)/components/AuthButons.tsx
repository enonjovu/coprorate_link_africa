...
const AuthButtons = () => {
    ...
    return (
        status === "authenticated" ?
            (
                <button type="button" onClick={() => { signOut({ callbackUrl: "/" }) }} className="cursor-pointer flex items-center gap-x-2 font-semibold text-gray-500 hover:text-red-600 sm:border-s sm:border-gray-300 sm:my-6 sm:ps-6 dark:border-gray-700 dark:text-red-500 dark:hover:text-red-500">
                    Sign Out
