        ...
        <div className="max-w-xl mx-auto">
            ...
            <form key={formKey}>
                <div className="grid gap-4 lg:gap-6">
                    <div>
                        <label htmlFor="title" className="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Directory Title</label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                        <div>
                            <label htmlFor="blog-image" className="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Company Image</label>
                            <UploadButton
                        ...
                        <div>
                            <label htmlFor="category" className="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Company Category</label>
                    ...
                    <div>
                        <label htmlFor="story" className="block mb-2 text-sm text-gray-700 font-medium dark:text-white">Direcoty Details</label>
