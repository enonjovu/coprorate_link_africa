    ...
    return (
        <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
            ...
            >
                <button
                    type="button"
                    className="active flex w-full flex-col rounded-xl p-3 text-start hover:bg-gray-100 hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 dark:hs-tab-active:bg-white/[.05] md:p-5"
                ...
                >
                    <svg
                        className="hidden h-7 w-7 flex-shrink-0 text-gray-800 hs-tab-active:text-blue-600 dark:text-white dark:hs-tab-active:text-blue-500 sm:block"
                ...
                <button
                    type="button"
                    className="flex w-full flex-col rounded-xl p-3 text-start hover:bg-gray-100 hs-tab-active:bg-gray-100 hs-tab-active:hover:border-transparent dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 dark:hs-tab-active:bg-white/[.05] md:p-5"
                    ...
                    <div className="relative max-w-[1140px] lg:pb-32">
                        ...
                        <figure className="relative z-[1] me-20 ms-auto h-auto w-[50rem] max-w-full rounded-b-lg shadow-[0_2.75rem_3.5rem_-2rem_rgb(45_55_75_/_20%),_0_0_5rem_-2rem_rgb(45_55_75_/_15%)] dark:shadow-[0_2.75rem_3.5rem_-2rem_rgb(0_0_0_/_20%),_0_0_5rem_-2rem_rgb(0_0_0_/_15%)]">
                            <div className="relative flex max-w-[50rem] items-center rounded-t-lg border-b border-gray-100 bg-white px-24 py-2 dark:border-gray-700 dark:bg-gray-800">
                                ...
                                <div className="flex h-full w-full items-center justify-center rounded-sm bg-gray-200 text-[.25rem] text-gray-800 dark:bg-gray-700 dark:text-gray-200 sm:text-[.5rem]">
                                    www.preline.co
                                </div>
                            </div>
