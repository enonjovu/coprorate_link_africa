        ...
        <form className="hidden sm:block">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    id="icon"
                    name="icon"
                    className="block w-full rounded-lg border-gray-200 px-4 py-2 ps-11 text-sm text-black focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-400 dark:focus:ring-gray-600"
                    placeholder="Search"
                />
            </div>
        </form>
